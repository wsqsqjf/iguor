...
<script src="${ctxStatic}/jquery/jquery-extend.js" type="text/javascript"></script>
...
<link href="${ctxStatic}/bootstrap/metronic/css/style.css" type="text/css" rel="stylesheet" />
